...
module.exports = {
  async up(queryInterface) {
    const now = new Date();
    const perms = [
      'inventario.mezclas.ver',
      'inventario.mezclas.crear',
      'inventario.mezclas.editar',
      'inventario.mezclas.eliminar',
      'inventario.mezclas.elaborar',
      'menu.inventarios.mezclas',
      'menu.inventarios.elaboraciones',
    ];
