...
module.exports = {
  async up(queryInterface) {
    const now = new Date();
    const perms = [
      'inventario.proformas.ver',
      'inventario.proformas.crear',
      'inventario.proformas.editar',
      'inventario.proformas.eliminar',
      'inventario.proformas.convertir',
      'menu.inventarios.proformas',
    ];
