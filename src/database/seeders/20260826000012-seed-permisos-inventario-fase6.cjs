...
module.exports = {
  async up(queryInterface) {
    const now = new Date();
    const perms = [
      'inventario.planes.ver',
      'inventario.planes.crear',
      'inventario.planes.editar',
      'inventario.planes.eliminar',
      'inventario.programaciones.ver',
      'inventario.programaciones.crear',
      'inventario.programaciones.editar',
      'inventario.programaciones.eliminar',
      'inventario.ordenes.ver',
      'inventario.ordenes.crear',
      'inventario.ordenes.editar',
      'inventario.ordenes.eliminar',
      'inventario.ordenes.cerrar',
      'menu.inventarios.planes',
      'menu.inventarios.programaciones',
      'menu.inventarios.ordenes',
    ];
