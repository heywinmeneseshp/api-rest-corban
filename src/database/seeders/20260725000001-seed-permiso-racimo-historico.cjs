...
module.exports = {
  async up(queryInterface) {
    ...
    const permiso = PERMISSIONS_SEED.find((p) => p.codigo === PERMISSIONS.RACIMO_MOVIMIENTO_EDITAR_HISTORICO);
  ...
  async down(queryInterface) {
    ...
    await queryInterface.bulkDelete('permisos', { codigo: PERMISSIONS.RACIMO_MOVIMIENTO_EDITAR_HISTORICO });
  },
};
