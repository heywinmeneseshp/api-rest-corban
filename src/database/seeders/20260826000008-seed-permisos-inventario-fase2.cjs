...
module.exports = {
  async up(queryInterface) {
    const now = new Date();
    const perms = [
      'inventario.motivos.ver', 'inventario.motivos.crear', 'inventario.motivos.editar', 'inventario.motivos.eliminar',
      'inventario.movimientos.ver', 'inventario.movimientos.crear',
      'menu.inventarios.motivos', 'menu.inventarios.movimientos',
    ];
