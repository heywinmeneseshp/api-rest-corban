...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('suma_bruta', {
      ...
      candela: { type: Sequelize.DECIMAL(6, 2), allowNull: true },
    ...
    // evaluacion_id ya queda indexado por la restricción unique de arriba (1 suma_bruta por evaluación).
  },

  async down(queryInterface) {
    await queryInterface.dropTable('suma_bruta');
  },
};
