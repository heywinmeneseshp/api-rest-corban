...
export const listMotivosRepiqueSchema = Joi.object({
  body: Joi.object({}),
  params: Joi.object({}),
  query: Joi.object({
...
export const getMotivoRepiqueSchema = Joi.object({
  body: Joi.object({}),
  params: Joi.object({ uuid: uuidParam }),
  query: Joi.object({}),
});

export const createMotivoRepiqueSchema = Joi.object({
  body: Joi.object({
...
export const updateMotivoRepiqueSchema = Joi.object({
  body: Joi.object({
