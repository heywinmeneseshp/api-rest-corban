...
router.get('/', auth, permission(PERMISSIONS.INVENTARIO_ALMACENES_VER), validate(listAlmacenSchema, 'query'), almacenController.list);
router.post('/', auth, permission(PERMISSIONS.INVENTARIO_ALMACENES_CREAR), validate(createAlmacenSchema), almacenController.create);
router.get('/:uuid', auth, permission(PERMISSIONS.INVENTARIO_ALMACENES_VER), validate(getAlmacenSchema, 'params'), almacenController.getByUuid);
...
router.delete('/:uuid', auth, permission(PERMISSIONS.INVENTARIO_ALMACENES_ELIMINAR), validate(getAlmacenSchema, 'params'), almacenController.remove);
