...
import zonaRoutes from './routes/agricola/zona.routes.js';
...
import pronosticoRoutes from './routes/agricola/pronostico.routes.js';
import estimacionFincaRoutes from './routes/agricola/estimacionFinca.routes.js';
...
router.use('/pronostico', pronosticoRoutes);
router.use('/estimaciones', estimacionFincaRoutes);
