export const PERMISSIONS = {
  ...
  MENU_INVENTARIOS_ARTICULOS: 'menu.inventarios.articulos',
...
export const PERMISSIONS_SEED = [
  ...
  { codigo: PERMISSIONS.INVENTARIO_ARTICULOS_VER, nombre: 'Ver artículos de inventario' },
  { codigo: PERMISSIONS.INVENTARIO_ARTICULOS_CREAR, nombre: 'Crear artículos de inventario' },
  { codigo: PERMISSIONS.INVENTARIO_ARTICULOS_EDITAR, nombre: 'Editar artículos de inventario' },
  { codigo: PERMISSIONS.INVENTARIO_ARTICULOS_ELIMINAR, nombre: 'Eliminar artículos de inventario' },
  ...
  { codigo: PERMISSIONS.MENU_INVENTARIOS_ARTICULOS, nombre: 'Ver submenú Artículos (Inventarios)' },
